...
#define NON_PREEMPTIVE_FCFS		1
#define NON_PREEMPTIVE_SJF  	2
#define PREEMPTIVE_RR			3
#define PREEMPTIVE_PRIORITY 	4
#define ALPHA					0.5
#define SJF_INITIAL				SystemTick
...
extern int finishTime[];
extern unsigned int algo_num;
extern int cpu_burst_start;

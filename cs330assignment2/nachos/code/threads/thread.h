...
class NachOSThread {
	...
	public:
		...
		NachOSThread(char* debugName, int priority_val);		// alternate initialization
		...
		int threadPriority;				// priority value of the currentThread
		int cpu_usage;
		...
		void set_wait_time_start(int t);
		int get_wait_time_start();
		int basePriority;

...
class Statistics {
  public:
	...
	int min_cpu_burst;
	float avg_cpu_burst;
	int burst_estimate_error;

	int num_cpu_bursts;
	float total_wait_time;

	int max_thread_completion;
	int min_thread_completion;
	float avg_thread_completion;
	float var_thread_completion;
...
#define TimerTicks 	90    	// (average) time between timer interrupts
//#define TimerTicks 	62    	// (average) time between timer interrupts
//#define TimerTicks 	93    	// (average) time between timer interrupts
